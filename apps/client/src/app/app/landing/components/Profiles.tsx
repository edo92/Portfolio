...
export const Profiles: React.FC = () => (
   <div className="mt-5 flex w-full self-stretch pt-12 md:mt-2 md:px-0 md:pt-28">
      <div className="flex w-full flex-wrap items-center justify-center gap-4 px-3">
         {links.map((item, index) => (
            <div
               ...
               className={cn(
                  item.style,
                  'flex cursor-pointer flex-col justify-center whitespace-nowrap rounded-md p-0.5 text-center text-lg font-light'
               )}
            >
