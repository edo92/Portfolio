...
export const Projects: React.FC = () => {
   ...
   return (
      <div className="flex w-full grow items-center justify-center p-16 pt-32">
         <div className="flex w-full flex-col items-start justify-center gap-3 sm:w-3/4 md:w-11/12 lg:w-3/4 xl:w-4/6">
            <div className="flex w-full flex-col items-start">
               <Heading variant='h3' size="2xl">Projects</Heading>
            </div>
