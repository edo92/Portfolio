...
export default function Timeline() {
  ...
  return (
    <div ref={containerRef} className="relative bg-background-secondary py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          <motion.div
            className={cn("absolute inset-y-0 left-[49.94%] w-0.5 bg-secondary-foreground/40 dark:bg-secondary/80")}
            style={{
              scaleY,
              originY: 0,
              height: "105%",
    ...
    >
      <div className="w-5/12">
        <div className="transform-gpu" onClick={onToggle}>
          <motion.div
            className="rounded-lg border p-6 shadow-lg transition-all duration-300 ease-in-out cursor-pointer"
            whileHover={{
              scale: 1.02,
              zIndex: 20,
            }}
          ...
          >
            ...
            >
              <Paragraph variant="p" weight="medium" size="sm" className="mt-2 text-body/80">
                {event.details}
              </Paragraph>
            </motion.div>
          </motion.div>
